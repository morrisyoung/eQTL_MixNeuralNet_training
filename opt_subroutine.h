...
void forward_backward(string, array<float *, 22> *, vector<float> *, float *, float *, float *, float *, vector<vector<float *>> *, vector<vector<float *>> *, vector<float *> *, vector<float *> *, vector<float *> *);
